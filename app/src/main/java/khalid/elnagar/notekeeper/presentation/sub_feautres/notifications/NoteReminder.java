package khalid.elnagar.notekeeper.presentation.sub_feautres.notifications;
...
public class NoteReminder {
    ...
    public static void notify(final Context context,
        ...
        final NotificationCompat.Builder builder = new NotificationCompat.Builder(context)
                ...
                .setContentTitle(context.getString(R.string.review_note))
                .setContentText(noteText)

                .setStyle(new NotificationCompat.BigTextStyle()
                        .bigText(noteText)
                        .setBigContentTitle(noteTitle)
                        .setSummaryText(context.getString(R.string.review_note)))
                ...
                .setTicker(context.getString(R.string.review_note))
